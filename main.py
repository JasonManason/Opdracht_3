...
for i in list_table_names('sub_sub_category'):
     create_new_table(i)

for j in list_table_names('personality_type'):
     create_new_table(j)
...
def sub_sub_category_inserts():
    ...
    """
    names_sub_sub_category = sorted(list_table_names('names_sub_sub_category'), key=lambda empty: (empty is None, empty))
    sub_sub_category = sorted(list_table_names('sub_sub_category'), key=lambda empty: (empty is None, empty))
...
def personality_type_inserts():
    new_personality_type = sorted(list_table_names('personality_type'))
